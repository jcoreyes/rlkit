...
class AbstractMDPsContrastive:
    ...
    def gen_plot(self, likelihood, i, encoder_lst):
        ...
        plt.imshow(plots)
        plt.savefig('/home/jcoreyes/abstract/rlkit/examples/abstractmdp/exps/exp6/fig_%.3f_%d.png' % (likelihood, i))
        #plt.show()
...
if __name__ == '__main__':
    ...
    envs = [FourRoomsModEnv(gridsize=11, room_wh=(5, 5)),
            FourRoomsModEnv(gridsize=11, room_wh=(5, 5), close_doors=["west"]),
    ...
    for i in range(tries):
        ...
        likelihood = a.train(i, max_epochs=300)
        #print(a.mean_t)
        #print(a.y1)
